...
public class AccountDaoImp implements AccountDao {
	...
	/*
	 * @Override public String updateAccount(String accountNumber, Account account)
	 ...
	 * map.put(account.getAccountNumber(), account);
	 * 
	 * else throw new AccountException("account doesn't exsist");
	 * 
	 * return account.getAccountNumber();
	 * 
	 * }
	 * 
	 * @Override public Account findAccount(String accountNumber) throws
	 * AccountException {
	 * 
	 * Account a = null; if(map.containsKey(accountNumber)) a =
